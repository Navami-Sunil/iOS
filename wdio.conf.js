exports.config = {
  ...
  services: [
    [
      "browserstack",
      {
        ...
        app:'bs://3d1ea4e22ff013e00bcbb9b057e1d19ab3b92fd7'
      },
    ],
  ],
  ...
  commonCapabilities: {
    "bstack:options": {
      osVersion: "17",
      projectName: "SauceLabs iOS Demo App - 101th-time-trying",
      buildName: "bstack-demo",
      debug: true,
      networkLogs: true,
    },
...
//     //
//     user: process.env.hoxexe_CwcFs4,
//     key: process.env.h6xmXszMN8zCwDnaiEm1,
//     //
...
//     // ===================
//     // Test Configurations
//     // ===================git clone https://github.com/browserstack/webdriverio-browserstack.git
